...
# ./scripts/main_experiments/01_from_scratch/train_MBBN_from_scratch-ENIGMA_OCD-five_channel_vmd.sh      ### CHECK ###
# ./scripts/main_experiments/01_from_scratch/train_MBBN_from_scratch-ENIGMA_OCD-five_channel_vmd.sh  | tee /pscratch/sd/p/pakmasha/ENIGMA_OCD_MBBN_git/ENIGMA_OCD_MBBN/MBBN-main/failed_experiments/output
...
--seq_part head --fmri_dividing_type five_channels \
--spatiotemporal --spat_diff_loss_type minus_log --spatial_loss_factor 4.0 \
--exp_name vmd_five_ch_700_seed2 --seed 2 --sequence_length_phase2 700 \
--intermediate_vec 316 --nEpochs_phase2 150 --num_heads 4 \
...
# ./scripts/main_experiments/01_from_scratch/train_MBBN_from_scratch-ENIGMA_OCD-four_channel.sh  ### CHECK ###
