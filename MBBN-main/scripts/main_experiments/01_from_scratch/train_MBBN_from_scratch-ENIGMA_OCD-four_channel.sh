...
# ./scripts/main_experiments/01_from_scratch/train_MBBN_from_scratch-ENIGMA_OCD-four_channel.sh | tee /global/homes/p/pakmasha/model/MBBN-main/failed_experiments/output.log
...
--exp_name vmd_four_ch_seqlen300_padding_with_mask_seed3 --seed 3 --sequence_length_phase2 300 \
