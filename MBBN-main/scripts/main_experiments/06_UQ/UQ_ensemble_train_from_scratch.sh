...
--spatiotemporal --spat_diff_loss_type minus_log --spatial_loss_factor 4.0 \
--exp_name ensemble_four_ch_seed12 --seed 12 --sequence_length_phase2 100 \
...
2> /pscratch/sd/y/ycryu/ENIGMA_OCD_MBBN/MBBN-main/failed_experiments/enigma_ocd_error_four_ensemble_12.log
